...
// FindMoreByNames returns a list of FileDescriptorProto if all the names are found
// in the registered proto files.
func FindMoreByNames(filename ...string) ([]*descriptorpb.FileDescriptorProto, error) {
